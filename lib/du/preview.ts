...
export const previewAnswers = [{ id: 'preview-answer', student_id: 'preview-friend', case_no: 1, found_items: ['p_name', 'p_phone'], choices: { p_now: 0, p_keep: 0, p_next: 1 }, completed: true }];
