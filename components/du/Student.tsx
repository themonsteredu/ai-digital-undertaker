...
import ParcelIntro from './ParcelIntro';
...
export default function Student({ initial, token, onExit }: {
 ...
 {step.kind === 'intro' && <div className="intro"><div className="intro-visual">{n === 1 ? <ParcelIntro /> : <img src={'/art/' + (['scene-parcel', 'scene-classroom', 'slide-03', 'slide-05'][n - 1]) + '.png'} alt={c.short}/>}</div><div className="request"><span className="eyebrow">의뢰인 · {c.client}</span><blockquote>“{c.quote}”</blockquote></div></div>}
